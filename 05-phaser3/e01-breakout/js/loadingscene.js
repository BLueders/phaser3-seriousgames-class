...
loadingScene.preload = function() {
    ...
    loadingBarBackground.fillStyle("#AAAAAA", 0.2);
    ...
    this.load.image('metalblock', 'assets/metalblock.png');
    this.load.image('metalblock2', 'assets/metalblock2.png');
    this.load.image('paddle', 'assets/paddle.png');
    this.load.image('redblock', 'assets/redblock.png');
    this.load.image('star', 'assets/star.png');
    this.load.image('woodblock', 'assets/woodblock.png');
